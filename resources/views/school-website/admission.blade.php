                                    ...
                                    @foreach ($extraFields as $key => $data)
                                            ...
                                            <div class='form-group col-md-12 col-lg-6 col-xl-4 col-sm-12'>
                                                ...
                                                @elseif($data->type == 'number')
                                                    <input type="number" name="extra_fields[{{ $key }}][data]" min="0" class="form-control number-fields" id="{{ $data->type }}_{{ $key }}" placeholder="{{ $data->name }}" {{ $data->is_required == 1 ? 'required' : '' }}>
                                                ...
                                                @elseif($data->type == 'dropdown')
                                                                ...
                                                                @foreach ($data->default_values as $keyRadio => $value)
                                                                    <div class="form-check mr-2">
                                                                        <label class="form-check-label">
                                                                            <input type="radio" name="extra_fields[{{ $key }}][data]" value="{{ $value }}" id="{{ $data->type }}_{{ $keyRadio }}" class="radio-fields" {{ $data->is_required == 1 ? 'required' : '' }}>
                                                                            {{$value}}
                                                                        </label>
                                                                    </div>
                                                                @endforeach
                                                            ...
                                                            <div class="row col-lg-12 col-xl-6 col-md-12 col-sm-12 ms-1" style="gap:1rem;">
                                                                @foreach ($data->default_values as $chkKey => $value)
                                                                    <div class="mr-2 form-check">
                                                                        <label class="form-check-label">
                                                                            <input type="checkbox" name="extra_fields[{{ $key }}][data][]" value="{{ $value }}" id="{{ $data->type }}_{{ $chkKey }}" class="form-check-input chkclass checkbox-fields" {{ $data->is_required == 1 ? 'required' : '' }}> {{ $value }}
                                                                        </label>
                                                                    </div>
                                                                @endforeach
                                                            </div>
                                                    ...
                                                    @elseif($data->type == 'file')
                                                        <div class="input-group col-xs-12">
                                                            <input type="file" name="extra_fields[{{ $key }}][data]" class="file-select" id="{{ $data->type }}_{{ $key }}" {{ $data->is_required ? 'required' : '' }} style="display: none;">
