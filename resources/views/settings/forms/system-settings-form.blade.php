        ...
        <div class="form-group col-md-3 col-sm-12">
            ...
            <div class="d-flex">
                <div class="form-check form-check-inline">
                    <label class="form-check-label">
                        <input type="radio" name="school_inquiry" value="1" class="default" {{ ($settings['school_inquiry'] == 1) ? 'checked' : '' }}>{{ __('enable') }}
                    </label>
                </div>
                <div class="form-check form-check-inline">
                    <label class="form-check-label">
                        <input type="radio" name="school_inquiry" value="0" class="custom" {{ ($settings['school_inquiry'] == 0) ? 'checked' : '' }}>{{ __('disable') }}
                    </label>
                </div>
            </div>
        </div>
