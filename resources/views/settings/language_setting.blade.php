    ...
    <div class="content-wrapper">
        ...
        <div class="row grid-margin">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form id="formdata" class="create-form" data-success-function="formSuccessFunction"
                            action="{{ route('language.store') }}" novalidate="novalidate" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="form-group col-md-6 col-sm-12">
                                    <label for="name">{{ __('language_name') }} <span class="text-danger">*</span></label>
                                    <input name="name" id="name" type="text" required
                                        placeholder="{{ __('language_name') }}" class="form-control" />
                                </div>
                                <div class="form-group col-md-6 col-sm-12">
                                    <label for="code">{{ __('language_code') }} <span class="text-danger">*</span></label>
                                    <input name="code" id="code" type="text" required
                                        placeholder="{{ __('language_code') }}" class="form-control" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6 col-sm-12">
                                    ...
                                    <div class="input-group col-xs-12">
                                        <input type="text" class="form-control file-upload-info" accept="application/json"
                                            disabled="" placeholder="{{ __('upload_file') }}" aria-label="" />
                                ...
                                <div class="form-group col-md-6 col-sm-12">
                                    <input class="form-check-input mt-0 mx-1" type="checkbox" value="1" name="rtl" id="rtl"
                                ...
                                <table aria-describedby="mydesc" class='table' id='table_list' data-toggle="table"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" data-field="is_rtl" data-sortable="false"
                                                data-formatter="yesAndNoStatusFormatter">{{ __('Is RTL') }}</th>
                                            <th scope="col" data-field="status" data-formatter="activeStatusFormatter"
                                                data-sortable="false" data-visible="false">{{ __('status') }}</th>
                                            <th data-events="languageSettingsEvents" scope="col" data-field="operate"
    ...
    <div class="modal fade" id="editModal" data-backdrop="static" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="edit-form" data-success-function="formSuccessFunction" action="{{ url('language') }}"
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="form-group col-sm-12 col-md-12">
                                ...
                                <input type="text" name="name" id="edit_name" class="form-control"
                                    placeholder="{{ __('language_name') }}" required>
                        ...
                        <div class="row">
                            <div class="form-group col-sm-12 col-md-12">
                                ...
                                <input type="text" name="code" id="edit_code" class="form-control"
                                    placeholder="{{ __('language_code') }}" required>
                            ...
                            <div class="form-group col-sm-12 col-md-12">
                                ...
                                <div class="input-group col-xs-12">
                                    <input type="text" class="form-control file-upload-info" disabled=""
                                        placeholder="{{ __('upload_file') }}" aria-label="" />
                                    <span class="input-group-append">
                                        <button class="file-upload-browse btn btn-theme"
                                            type="button">{{ __('upload') }}</button>
                                    </span>
                        ...
                        <div class="row">
                            <div class="form-group col-sm-12 col-md-12 mx-1.5">
                                <input class="form-check-input" type="checkbox" name="rtl" value="1" id="edit_rtl">
