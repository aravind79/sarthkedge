                            ...
                            <div class="border border-secondary rounded-lg mb-2">
                                <div class="row my-4 mx-1">
                                    ...
                                    <div class="form-group col-md-4 col-sm-12">
                                        ...
                                        <input name="school_code" id="school_code"
                                            value="{{ Auth::user()->school->code ?? '' }}" type="text" disabled
                                            placeholder="{{ __('school_code') }}" class="form-control" />
                                    </div>
                                            ...
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" name="domain_type" value="default" class="default"
                                                        {{ $domain_type == 'default' ? 'checked' : '' }}> {{ __('default') }}
                                                </label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" name="domain_type" value="custom" class="custom" {{ $domain_type == 'custom' ? 'checked' : '' }}> {{ __('custom') }}
                                                </label>
                                            </div>
                                        </div>
                                    </div>
