...
@section('content')
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <button type="button" class="btn btn-theme" data-toggle="modal" data-target="#createModal">
                                <i class="fa fa-plus-circle mr-1"></i> {{ __('create') . ' ' . __('Semester') }}
                            </button>
                        </div>
                                ...
                                <table aria-describedby="mydesc" class='table' id='table_list' data-toggle="table"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" data-field="current" data-formatter="yesAndNoStatusFormatter">
                                                {{__('Current')}}
                                            </th>
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="createModalLabel">{{ __('create') . ' ' . __('Semester') }}</h5>
    ...
    <div class="modal fade" id="editModal" data-backdrop="static" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editModalLabel"> {{ __('edit') . ' ' . __('Semester') }}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true"><i class="fa fa-close"></i></span>
                    </button>
                </div>

                <form action="{{ url('semester') }}" class="edit-form pt-3 " id="formdata" method="POST"
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12 col-md-4">
                                <label for="edit-start-month">{{ __('Start Month') }} <span
