                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-end">
                            <a class="btn btn-sm btn-theme"
                                href="{{ route('online-exam-question.index') }}">{{ __('back') }}</a>
                        </div>
                        <form class="pt-3 mt-6" id="edit-online-exam-questions-form" method="POST"
                            action="{{ route('online-exam-question.index') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text"
                                        value="{{ $onlineExamQuestion->online_exam_question_commons->first()->class_subject->subject_with_name }}"
                            ...
                            <div class="bg-light p-4">
                                <div class="form-group">
                                    ...
                                    <textarea class="editor_question" name="question" required
                                        placeholder="{{__('enter') . ' ' . __('question')}}">{{htmlspecialchars_decode($onlineExamQuestion->question)}}</textarea>
                                </div>
                                <div class="options-data">
                                    <div data-repeater-list="option_data" class="row">
                                        <div class="form-group col-lg-6 col-md-12" data-repeater-item>
                                            ...
                                            <textarea class="edit_editor_options" name="option" required
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 p-1">
                                        ...
                                        <input type="text" name="note"
                                            value="{!! htmlspecialchars_decode($onlineExamQuestion->note) !!}"
                                            class="form-control">
                                    </div>
                                    <div class="form-group col-md-6 p-1">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input class="medium" name="difficulty" type="radio" {{ $onlineExamQuestion->difficulty == 'medium' ? 'checked' : '' }}
                                                        value="medium">Medium
                                                    <i class="input-helper"></i></label>
                                            </div>
                                            <div class="form-check form-check-inline">
