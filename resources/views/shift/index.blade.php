...
@section('content')
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <button type="button" class="btn btn-theme" data-toggle="modal" data-target="#createModal">
                                <i class="fa fa-plus-circle mr-1"></i> {{ __('create') . ' ' . __('Shift') }}
                            </button>
                        </div>
                        <div class="d-block">
                            <div class="">
                        ...
                        <table aria-describedby="mydesc" class='table' id='table_list' data-toggle="table"
                            data-url="{{ url('shift/show') }}" data-click-to-select="true" data-side-pagination="server"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" data-field="status" data-sortable="false"
                                        data-formatter="shiftStatusFormatter">{{__('status')}}</th>
                                    ...
                                    <th scope="col" data-field="operate" data-sortable="false" data-events="shiftEvents"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="createModalLabel">{{ __('create') . ' ' . __('new') . ' ' . __('Shift') }}
                    </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form class="pt-3 section-create-form" id="create-form" action="{{route('shift.store')}}" method="POST"
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editModalLabel">{{__('edit') . ' ' . __('Shift')}}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form class="pt-3 section-edit-form" id="edit-form" action="{{ url('shifts') }}" novalidate="novalidate">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12">
                                <label for="edit_start_time">{{ __('start_time') }} <span
                                ...
                                <div class="d-flex">
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" name="status" value="1" id="edit_status_active">
                                            {{ __('Active') }}
                                        </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" name="status" value="0" id="edit_status_inactive">
                                            {{ __('Inactive') }}
                                        </label>
                                    </div>
                                </div>
