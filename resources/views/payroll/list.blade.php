                    ...
                    <div class="card-body">
                        ...
                        <div class="staff-table">
                            ...
                            <table aria-describedby="mydesc" class='table' id='table_list' data-toggle="table"
                                data-url="{{ route('payroll.slip.list') }}" data-click-to-select="true"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" data-field="basic_salary" data-formatter="amountFormatter">
                                            {{ __('basic_salary') }}</th>
                                        <th scope="col" data-field="amount" data-formatter="amountFormatter"
