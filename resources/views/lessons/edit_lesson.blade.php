            ...
            <div class="col-md-12 grid-margin stretch-card search-container">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="pt-3 edit-lesson-form" id="edit-form" data-success-function="formSuccessFunction"
                            action="{{ route('lesson.update', [$lesson->id]) }}" method="POST" novalidate="novalidate">
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    <input type="text" id="name" value="{{ $lesson->name }}" name="name"
                                        ...
                                        <div class="form-group col-xl-3" id="file_thumbnail_div" style="display: none">
                                            ...
                                            <div style="width: 70px;">
                                                <a data-toggle='lightbox' href=><img
                                                        class="img-fluid w-70 thumbnail-preview mt-1" alt="" /></a>
                                            </div>
                                        </div>
