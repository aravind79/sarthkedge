                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="pt-3 edit-class-subject-validate-form" data-success-function="formSuccessFunction"
                            id="edit-form" action="{{ route('class-section.update', [$id]) }}" novalidate="novalidate">
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-12 col-12">
                                        ...
                                        <div class="form-group">
                                            {{-- <select name="class_teacher_id" id="class_teacher_id"
                                                ...
                                                <select multiple name="class_teacher_id[]" id="class_teacher_id"
                                                    data-class-section="{{$classSection->id}}"
                                                    class="form-control select2-dropdown select2-hidden-accessible"
                                                    style="width:100%;" tabindex="-1" aria-hidden="true"
                                                    data-placeholder="{{__("Search Teacher Name")}}">
                                                    @foreach ($teachers as $teacher)
                                                        <option value="{{ $teacher->id }}" {{ $classSection->class_teachers->contains('teacher_id', $teacher->id) ? "selected data-exists=true" : "data-exists=false" }}>
                                    ...
                                    <div class="col-md-4 col-sm-12 col-12">
                                        <h4 class="mb-3">{{ __('Section Capacity') }}</h4>
                                        <div class="form-group">
                                            <input name="capacity" id="capacity" type="number" min="1"
                                                value="{{ $classSection->capacity }}" placeholder="e.g., 40"
                                            ...
                                            <div class="row">
                                                @foreach ($classSubjects as $key => $classSubject)
                                                    @if($classSubject->semester_id == $data->id)
                                                        <input type="hidden" name="subject_teachers[{{ $key }}][semester_id]"
                                                            value="{{ $data->id }}">
                                                        <input type="hidden" name="subject_teachers[{{ $key }}][class_subject_id]"
                                                            value="{{ $classSubject->id }}">
                                                        <input type="hidden" name="subject_teachers[{{ $key }}][subject_id]"
                                                            value="{{ $classSubject->subject_id }}">
                                                        <div class="form-group col-sm-12 col-md-6 ">
                                                            <span class="form-control"
                                                                readonly>{{ $classSubject->subject->name_with_type }}</span>
                                                        </div>
                                                        <div class="form-group col-sm-12 col-md-6 ">
                                                            <select multiple name="subject_teachers[{{ $key }}][teacher_user_id][]]"
                                                                data-class-section="{{$classSection->id}}"
                                                                class="form-control select2-dropdown select2-hidden-accessible subject_teacher_id"
                                                                style="width:100%;" tabindex="-1" aria-hidden="true"
                                                                data-placeholder="{{__("Search Teacher Name")}}">
                                                                @foreach ($teachers as $teacher)
                                    ...
                                    <div class="subject-teachers-without-semesters bg-light p-3 mt-4">
                                        ...
                                        <div class="row">
                                            @foreach ($classSubjects as $key => $classSubject)
                                                ...
                                                <div class="form-group col-sm-12 col-md-6 ">
                                                    <span class="form-control"
                                                        readonly>{{ $classSubject->subject->name . ' - ' . $classSubject->subject->type }}</span>
                                                </div>
                                                <div class="form-group col-sm-12 col-md-6 ">
                                                    <select multiple name="subject_teachers[{{ $key }}][teacher_user_id][]]"
                                                        data-class-section="{{$classSection->id}}"
