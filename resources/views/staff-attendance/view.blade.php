                    ...
                    <div class="card-body">
                        ...
                        <div class="row" id="toolbar">
                            <div class="form-group col-sm-12 col-md-4">
                                <input type="text" name="date" id="date" class="datepicker-popup form-control"
                                    placeholder="{{ __('date') }}" data-date-end-date="0d" autocomplete="off" required>
                        ...
                        <div class="show_attendance_staff_list">
                            <table aria-describedby="mydesc" class='table staff_table' id='table_list' data-toggle="table"
                                data-url="{{ route('staff-attendance.list.show', 1) }}" data-click-to-select="true"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" data-field="staff_id" data-sortable="false" data-visible="false">
                                            {{__('user_id')}}</th>
                                        <th scope="col" data-field="user.staff.id" data-sortable="false"
                                            data-visible="false">{{__('staff_id')}}</th>
