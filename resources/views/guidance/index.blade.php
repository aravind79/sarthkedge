                ...
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="create-form pt-3" id="create-form" action="{{route('guidances.store')}}" method="POST"
                                    ...
                                    <table aria-describedby="mydesc" class='table' id='table_list' data-toggle="table"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" data-formatter="linkFormatter" data-field="link">
                                                    {{ __('link') }}</th>
                                                @if (Auth::user()->can('guidance-edit') || Auth::user()->can('guidance-delete'))
                                                    <th data-events="guidanceEvents" data-width="150" scope="col"
                        ...
                        <div class="row form-group">
                            <div class="col-sm-12 col-md-12">
                                ...
                                <input type="text" name="name" id="edit-name" class="form-control"
                                    placeholder="{{ __('name') }}" maxlength="30" required>
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col-sm-12 col-md-12">
