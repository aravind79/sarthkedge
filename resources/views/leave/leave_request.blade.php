            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <input type="hidden" name="holiday_days" class="form-control holiday_days"
                            value="{{ $holiday_days ?? '' }}">
                        <input type="hidden" name="public_holiday" class="form-control public_holiday"
                            ...
                            <div class="form-group col-sm-12 col-md-3">
                                ...
                                <select name="session_year_id" id="session_year_id" class="form-control">
                                    @foreach($sessionYear as $key => $sy)
                                        <option value="{{ $key }}" {{ $key == $current_session_year->id ? 'selected' : '' }}>
                                            {{ $sy }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row form-group">
                                <div class="col-sm-12 col-md-12">
                                    ...
                                    <input type="text" name="from_date" id="edit_from_date"
                                        class="form-control datepicker-popup datepicker-popup-no-past"
                                        placeholder="{{ __('from_date') }}" readonly required>
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                <div class="col-sm-12 col-md-12">
                                    ...
                                    <input type="text" name="to_date" id="edit_to_date"
                                        class="form-control datepicker-popup datepicker-popup-no-past"
                                        placeholder="{{ __('to_date') }}" readonly required>
                                </div>
                            </div>
