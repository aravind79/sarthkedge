...
window.examResultEvents = {
    ...
    'click .reset-password': function (e, value, row) {
        // Fill reset modal fields
        $('#reset_student_id').val(row.user_id);
        $('#reset_student_name').val(row.user.full_name || (row.user.first_name + ' ' + row.user.last_name));
        $('#reset_student_admission_no').val(row.admission_no);
...
window.teacherEvents = {
    'click .edit-data': function (e, value, row) {
        ...
        // Reset same-as checkbox when opening edit modal
        $('#edit_same_as_current_address').prop('checked', false);
        ...
        // Update form action to include the teacher's user id
        $('#editdata').attr('action', baseUrl + '/teachers/' + row.id);
...
window.holidayEvents = {
    'click .edit-data': function (e, value, row) {
        ...
        $('#edit-end-date').val(row.end_date ? moment(row.end_date, momentFormat).format(momentFormat) : '');
